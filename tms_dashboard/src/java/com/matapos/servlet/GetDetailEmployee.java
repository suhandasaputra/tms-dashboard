 ...
 * @author suhan
 */
@WebServlet(name = "GetDetailEmployee", urlPatterns = {"/GetDetailEmployee"})
public class GetDetailEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetDetailEmployee</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetDetailEmployee at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailemployee);
