 ...
 * @author suhan
 */
@WebServlet(name = "OptionDeviceType", urlPatterns = {"/OptionDeviceType"})
public class OptionDeviceType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Option</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Option at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetdevicetype);
