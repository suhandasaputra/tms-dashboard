 ...
 * @author azzam
 */
@WebServlet(name = "GetDetailTipe", urlPatterns = {"/GetDetailTipe"})
public class GetDetailTipe extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getdetailtipe);
