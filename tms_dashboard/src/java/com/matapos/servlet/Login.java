...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String password = newJson.get("pass").toString();
            req.put(FieldParameterMatapos.proccode, ProcessingCode.loginbackend);
            req.put(FieldParameterMatapos.user_id, user_id);
            req.put(FieldParameterMatapos.password, password);
