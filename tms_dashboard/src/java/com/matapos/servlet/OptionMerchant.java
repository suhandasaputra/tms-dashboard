 ...
 * @author suhan
 */
@WebServlet(name = "OptionEmployee", urlPatterns = {"/OptionEmployee"})
public class OptionMerchant extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetmerchant);
