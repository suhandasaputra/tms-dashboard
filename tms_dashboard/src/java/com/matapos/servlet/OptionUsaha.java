 ...
 * @author suhan
 */
@WebServlet(name = "OptionUsaha", urlPatterns = {"/OptionUsaha"})
public class OptionUsaha extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetbidangusaha);
