 ...
 * @author suhan
 */
@WebServlet(name = "OptionBrand", urlPatterns = {"/OptionBrand"})
public class OptionBrand extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.optiongetbrand);
