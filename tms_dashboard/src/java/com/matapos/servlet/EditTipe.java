 ...
 * @author suhan
 */
@WebServlet(name = "EditTipe", urlPatterns = {"/EditTipe"})
public class EditTipe extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            String tipe_id = newJson.get("tipe_id").toString();
            String device_type = newJson.get("device_type").toString();
            String user_id = newJson.get("user_id").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.edittipe);
            req.put("tipe_id", tipe_id);
            req.put("device_type", device_type);
