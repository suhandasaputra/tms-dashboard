 ...
 * @author suhan
 */
@WebServlet(name = "DeleteTipe", urlPatterns = {"/DeleteTipe"})
public class DeleteTipe extends HttpServlet {
...
//        MessageProcess mp = new MessageProcessImpl();
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.deletetipe);
