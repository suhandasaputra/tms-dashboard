<%-- 
    Document   : email_signup_confirmation
    Created on : 21-Feb-2020, 00:38:46
    Author     : matajari
--%>
        ...
        <div id="isi">
            ...
            <div id="box2">
                <div id="form" align="center">
                    <img src="#" alt="ini img user" id="img_key">
                    <strong><label id="welcomeback">ACCOUNT CREATED SUCCESSFUL</label></strong>
                    <br>
                    <label id="keterangan">Proceed login to your account</label>
                    <br>
