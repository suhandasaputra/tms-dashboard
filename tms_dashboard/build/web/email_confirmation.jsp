<%-- 
    Document   : email_confirmation
    Created on : 21-Feb-2020, 00:21:27
    Author     : matajari
--%>
        ...
        <div id="isi">
            ...
            <div id="box2">
                <div id="form" align="center">
                    <img src="#" alt="ini img email" id="img_key">
                    <strong><label id="welcomeback">EMAIL CHANGE SUCCESS</label></strong>
                    <br>
                    <label id="keterangan">Please Re login to your acount with your new Email</label>
                    <br>
